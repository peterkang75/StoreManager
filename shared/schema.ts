...
export const candidates = pgTable("candidates", {
  ...
  hasExperience: boolean("has_experience").default(false).notNull(),
  experience: text("experience"),
  availability: text("availability"),
  // availabilityDays: { mon: "NONE"|"MORNING"|"AFTERNOON"|"ALLDAY", tue: ..., ..., sun: ... }
  availabilityDays: jsonb("availability_days"),
  availabilityCommitment: text("availability_commitment"),
  desiredRate: text("desired_rate"),
  visaType: text("visa_type"),
  visaExpiry: text("visa_expiry"),
  visaExpiryMonth: text("visa_expiry_month"),
...
export const employees = pgTable("employees", {
  ...
  // Links back to the interview record that produced this employee, if any.
