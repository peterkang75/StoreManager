...
export class MemStorage implements IStorage {
  ...
  async createCandidate(insertCandidate: InsertCandidate): Promise<Candidate> {
    ...
    const candidate: Candidate = {
      ...
      birthYear: insertCandidate.birthYear ?? null,
      gender: insertCandidate.gender ?? null,
      nationality: insertCandidate.nationality ?? null,
      hasExperience: insertCandidate.hasExperience ?? false,
      experience: insertCandidate.experience ?? null,
      availability: insertCandidate.availability ?? null,
      availabilityDays: insertCandidate.availabilityDays ?? null,
      availabilityCommitment: insertCandidate.availabilityCommitment ?? null,
      ...
      visaExpiryMonth: insertCandidate.visaExpiryMonth ?? null,
  ...
  async createEmployee(insertEmployee: InsertEmployee): Promise<Employee> {
    ...
    const employee: Employee = {
      ...
      candidateId: insertEmployee.candidateId ?? null,
